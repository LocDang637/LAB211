...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        staffList.add(new Staff("C0001", "John Doe", Constant.PILOT));
        staffList.add(new Staff("C0002", "Alice Johnson", Constant.PILOT));
        staffList.add(new Staff("C0003", "Robert Smith", Constant.PILOT));
        staffList.add(new Staff("C0004", "Emily Davis", Constant.PILOT));
        staffList.add(new Staff("C0005", "William Brown", Constant.PILOT));
        staffList.add(new Staff("C0006", "Olivia Martinez", Constant.PILOT));
        staffList.add(new Staff("C0008", "Michael Taylor", Constant.FLIGHT_ATTENDANT));
        staffList.add(new Staff("C0009", "Sophia Garcia", Constant.FLIGHT_ATTENDANT));
        staffList.add(new Staff("C0010", "James Anderson", Constant.FLIGHT_ATTENDANT));
        staffList.add(new Staff("C0011", "Emma Wilson", Constant.FLIGHT_ATTENDANT));
        staffList.add(new Staff("C0012", "Daniel Thomas", Constant.FLIGHT_ATTENDANT));
        staffList.add(new Staff("C0013", "Christopher Moore", Constant.GROUND_STAFF));
        staffList.add(new Staff("C0014", "Isabella Lee", Constant.GROUND_STAFF));
        staffList.add(new Staff("C0015", "Joseph Hall", Constant.GROUND_STAFF));
        staffList.add(new Staff("C0016", "Mia White", Constant.GROUND_STAFF));
        staffList.add(new Staff("C0017", "David Harris", Constant.GROUND_STAFF));
        staffList.add(new Staff("C0018", "Ella Robinson", Constant.GROUND_STAFF));
                        ...
                        while (true) {
                            ...
                            switch (choice2) {
                                case 1:
                                    ...
                                    break;
                                case 2:
                                    schedules.addSchedule(flights.getListFlight(), staffList);
                                    break;
                                case 3:
