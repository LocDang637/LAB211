            ...
            switch (choice) {
                ...
                case 2:
                    while (true) {
                        ...
                        String productName = Validator.getString("Enter product name:", "Invalid!", "^(?!\\s*$).+");
                        int quantity = 0;
                        Products longProduct = new Long_Products(id, productName, quantity, null, null);
                        ...
                        if (checkProduct(id) == null) {
                            ...
                            for (int i = 0; i < productList.size(); i++) {
                                if (productList.get(i).getId().
                                    ...
                                    productList.get(i).
                                            setInventory_Number(newInventory);
                                    ((Long_Products)productList.get(i)).setMdate(mdate);
                                    ((Long_Products)productList.get(i)).setEdate(edate);
                                }
                            }
                            value = quantity;
                        }
