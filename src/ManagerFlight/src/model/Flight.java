...
public class Flight implements Serializable,Comparable<Flight>{
    ...
    public Flight(String number, String departure, String destination, Date departureTime, int duration, int[] seats) {
        this.number = number;
    ...
    public String toString() {
        return String.format("|%-15s|%-20s|%-20s|%-16s|%-10s|%-10s|\n",
                    ...
                    dateFormat.format(departureTime), duration,seats.length);
    }
